 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportcrd5">
        <div class="col-md-2">
          <h4>
            รายงานติดตั้ง
          </h4>
  ...
  ,(SELECT top 1 [TelHome] + ' , ' + [TelMobile] + ' , ' + [TelOffice] FROM [Bighead_Mobile].[dbo].[vw_GetAddress] WHERE AddressTypeCode = 'AddressInstall' AND refno = C.refno) AS AddressInstallTel
  ...
  ,(SELECT top 1 [TelHome] + ' , ' + [TelMobile] + ' , ' + [TelOffice] FROM [Bighead_Mobile].[dbo].[vw_GetAddress] WHERE AddressTypeCode = 'AddressPayment' AND refno = C.refno) AS AddressPaymentTel
