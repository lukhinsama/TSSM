      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <!--<div class="box-tools">-->
            <div class="col-md-4">
              <form role="form" data-toggle="validator" name="formSearchEmpHr" method="post" action="index.php?pages=contracteditbak">
          ...
          <div class="box-body table-responsive no-padding">
            <form role="form" data-toggle="validator" name="formUpdate" method="post" action="index.php?pages=contracteditbak">
...
<form role="form" data-toggle="validator" name="formUpdateReceipt" method="post" action="index.php?pages=contracteditbak">
