  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-md-3">
          <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportdept1">
          ...
          <?php
           ...
           <div class="box-body table-responsive no-padding">
              ...
              */
              ...
              where emp.SourceSystem != 'sale' AND emp.SaleCode IS NOT NULL AND lenReceipt = 17 AND emp.PositionCode LIKE 'dept%' $WHERE2
