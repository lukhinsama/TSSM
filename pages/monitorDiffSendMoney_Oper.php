        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <P><center><B>รายงานเทียบส่งเงินประจำเดือน ฝ่ายปฏิบัติการ และฝ่ายอื่นๆ</B></center></P>
            </div>
          ...
          <!--<div class="box-body">-->
            ...
            <tbody>
              <?php
              $sql_select = "SELECT DISTINCT data.*,E.FirstName+' '+E.LastName AS EmpName,ED.SaleCode,data.SumReceipt-SumSend AS DiffSend
FROM (
SELECT *
FROM (
...
WHERE LEFT(ED.SaleCode,1) IN ('2','9') OR ED.SaleCode IS NULL
";

$sql_select1 = $sql_select." ORDER BY ED.SaleCode ,data.CreateBy ";
