 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportbrn4">
        <div class="col-md-2">
          <h4>
            เก็บเงินงวดแรกรายบุคคล(บางส่วน)
          </h4>
        </div>
        <div class="col-md-2">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            ...
            <?php
            $httpExcelHead = "<P><center><B>รายงานสรุปการเก็บเงิน(บางส่วน)</B></center></P>
