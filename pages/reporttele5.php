 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reporttele5">
        <div class="col-md-2">
          <h4>
            รายงานติดตั้ง
          </h4>
        ...
        <div class="col-md-2">
          <div class="form-group group-sm">
              ...
              if (($_COOKIE['tsr_emp_permit'] == 1) || ($_COOKIE['tsr_emp_permit'] == 2) || ($_COOKIE['tsr_emp_permit'] == 14) || ($_COOKIE['tsr_emp_permit'] == 13)) {
                ...
                //$EmpID['0'] = "A06797";
                $sql_case = "SELECT TOP 1 PositionLevel FROM [Bighead_Mobile].[dbo].[Position] WHERE PositionID in (SELECT PositionCode FROM Bighead_Mobile.dbo.EmployeeDetail WHERE (EmployeeCode = 'A".substr($_COOKIE['tsr_emp_id'],1,5)."') AND ProcessType = 'TELE') ORDER BY PositionLevel DESC";
          ...
          <!--<div class="box-body">-->
            ...
            <table id="example2" class="table table-hover table-striped">
              ...
              <tr>
                ...
                <th style="text-align: center">ผู้ติดตั้ง</th>
  ...
  ,C.INSTALLDATE,C.SaleCode,C.SaleEmployeeCode,C.SaleTeamCode,C.PreSaleTeamCode,C.ProductSerialNumber,C.Model,C.MODE,C.sales,C.tradeindiscount,C.totalprice
...
,left(c.salecode,2) as LineWork
  ...
  where c.STATUS IN ('NORMAL','F') AND C.IsMigrate = 0 $WHERE $WHERE1 ORDER BY C.EFFDATE,C.REFNO ASC";
              ...
              <tr>
                ...
                <td style="text-align: center"><?=$row['PreSaleTeamCode']?></td>
                <td style="text-align: center"><?=$row['Model']?></td>
	...
	<script>
        ...
        */
				...
				$("#LvEmp").change(function(){
					...
					var LvEmp = $(this).val();
					$.ajax({
						url:"pages/getdata_type_search_tele.php",//url:"get_data.php",
						dataType: "json",//กำหนดให้มีรูปแบบเป็น Json
