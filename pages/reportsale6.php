 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportsale6">
        <div class="col-md-3">
          <h4>
            รายงานยกเลิกติดตั้ง
          </h4>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <P><center><B>รายงานยกเลิกติดตั้งประจำวัน</B></center></P>
              <!--
              <table width="100%">
                <tr>
            ...
            <?php
            $httpExcelHead = "<P><center><B>รายงานยกเลิกติดตั้งประจำวัน</B></center></P>
...
,C.Refno AS RefNoR,c.CONTNO As CONTNOR
 ...
 ,(SELECT SUM(Payamt) FROM Bighead_Mobile.dbo.Payment WHERE Refno = C.Refno) as Payamt
  ...
  where c.STATUS IN ('VOID') AND C.IsMigrate = 0 $WHERE $WHERE1 ORDER BY C.EFFDATE,C.REFNO ASC";
