 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportReprint1">
        <div class="col-md-3">
          <h4>
            รายงานปริ๊นใบเสร็จ
          </h4>
        ...
        <div class="col-xs-12">
          ...
          <div class="box-body">
            ...
            <tbody>";
                $httpExcel2 = "";
                /*
              $sql_case = "SELECT R.ReceiptCode, R.RefNo,C.CONTNO, R.DatePayment, R.TotalPayment,CONVERT(varchar(20),DH.DatePrint,105) +' '+ CONVERT(varchar(5),DH.DatePrint,108) AS DatePrint , DH.PrintOrder
...
INNER JOIN Bighead_Mobile.dbo.Employee AS E ON DH.CreateBy = E.EmpID
...
WHERE (DH.DocumentType = 1) AND DH.PrintOrder > 1
$WHERE order by DH.DatePrint ASC ";
*/


$sql_case = "SELECT  ReceiptCode,RefNo,CONTNO,DatePayment,TotalPayment,DatePrint
,E.FirstName + ' ' + E.LastName AS CreditName
,DC.PrefixName + ' ' + DC.CustomerName AS CustomerName,PaymentPeriodNumber,NUM AS PrintOrder
FROM (
