...
if (!empty($_REQUEST['EmpID'])) {
  ...
  if ($_REQUEST['EmpID'] == "7") {
    ...
    $WHERE1 = "AND C.SaleCode IN (SELECT DISTINCT SaleCode FROM [TSRData_Source].[dbo].[EmployeeDataParent_ALL]  WHERE StatusType = 'INSTALL' AND (EmployeeCodeLV2 = '".$_REQUEST['EmpID']."' OR EmployeeCodeLV3 = '".$_REQUEST['EmpID']."'
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportinstall5">
        <div class="col-md-2">
          <h4>
            รายงานติดตั้ง
          </h4>
	...
	<script>
        ...
        */
				...
				$("#LvEmp").change(function(){
					...
					var LvEmp = $(this).val();
					$.ajax({
						url:"pages/getdata_type_search_install.php",//url:"get_data.php",
						dataType: "json",//กำหนดให้มีรูปแบบเป็น Json
