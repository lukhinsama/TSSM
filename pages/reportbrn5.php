...
if (!empty($_REQUEST['EmpID'])) {
  ...
  /*
    ...
    */
    $WHERE1 = "AND C.salecode IN (SELECT DISTINCT SaleCode FROM [TSRData_Source].[dbo].[EmployeeDataParent_all] WHERE StatusType = 'BRN' AND (EmployeeCodeLV2 = '".$_REQUEST['EmpID']."' OR EmployeeCodeLV3 = '".$_REQUEST['EmpID']."'
OR EmployeeCodeLV4 = '".$_REQUEST['EmpID']."'
OR EmployeeCodeLV5 = '".$_REQUEST['EmpID']."' OR EmployeeCodeLV6 = '".$_REQUEST['EmpID']."' OR ParentEmployeeCode = '".$_REQUEST['EmpID']."')
       UNION ALL SELECT DISTINCT SaleCode FROM [TSRData_Source].[dbo].[EmployeeDataParent_ALL_BACKUP_20180604] WHERE StatusType = 'BRN' AND (EmployeeCodeLV2 = '".$_REQUEST['EmpID']."'
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportbrn5">
        <div class="col-md-2">
          <h4>
            รายงานติดตั้ง
          </h4>
          ...
          <!--<div class="box-body">-->
            ...
            <tbody>";
                $httpExcel2 = "";
                  ...
                  $orderbysalecode = "ORDER BY C.SaleTeamCode,C.SaleSubTeamCode,C.SaleCode,C.ContractReferenceNo ASC";
...
$sql_print = $sql_select." ".$orderbysalecode;
              ...
              <?php
                ...
                write_data_for_export_excel($html_file, 'ReportBRN');
               ?>
             </tbody>
             <tfoot>
             </tfoot>
        ...
        -->
          ...
          <a href="export_excel.php?report_type=7"><img src="http://app.thiensurat.co.th/tsr_car/image/excel-icon.png" width="35" height="auto"> </a>
          </div>
        </div>
        <?php
          }
