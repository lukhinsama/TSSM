 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportsale2">
        <div class="col-md-3">
          <h4>
            เก็บเงินงวดแรกรายบุคคล
          </h4>
        </div>
        <div class="col-md-4">
          <?php
          ...
          <div class="box-body">
            ...
            <tbody>";
              ...
              <tr>
                ...
                <?php
                  if ($row['NetAmount'] != $row['PAYAMT']) {
                    ?>
                    <td style="text-align: center"><a class="text-primary"><?=$i?></a></td>
                    <td><a class="text-primary"><?=$row['ReceiptCode']?></a></td>
                    <td style="text-align: center"><a class="text-primary"><?=DateTimeThai($row['PaymentDueDate'])?> น.</a></td>
                    <td style="text-align: center"><a class="text-primary"><?=$row['PaymentPeriodNumber']?></a></td>
                    <td style="text-align: center"><a class="text-primary"><?=$row['RefNo']?></a></td>
                    <td style="text-align: center"><a class="text-primary"><?=$row['CONTNO']?></a></td>
                    <td><a class="text-primary"><?=$row['CustomerName']?></a></td>
                    <td style="text-align: right"><a class="text-primary"><?=number_format($row['PAYAMT'],2)?></a></td>
                    <td style="text-align: right"><a class="text-primary"><?=number_format($row['NetAmount'],2)?></a></td>
                    <?PHP
                  }else {
                    ?>
                    <td style="text-align: center"><?=$i?></td>
