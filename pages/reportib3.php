...
if (!empty($_REQUEST['EmpID'])) {
  ...
  if ($_REQUEST['EmpID'] == "7") {
    ...
    if (($_COOKIE['tsr_emp_permit'] == 1) || ($_COOKIE['tsr_emp_permit'] == 2) || ($_COOKIE['tsr_emp_permit'] == 6) || ($_COOKIE['tsr_emp_permit'] == 19)) {
      $_REQUEST['EmpID'] = "A39768";
    }else {
      $_REQUEST['EmpID'] = "A".substr($_COOKIE['tsr_emp_id'],1,5);
    }
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportib3">
        <div class="col-md-2">
          <h4>
            รายงานติดตั้ง
          </h4>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <P><center><B> พนักงานเก็บเงิน : ประจำวันที่ : ".$searchDate." พิมพ์โดย : ".$_COOKIE['tsr_emp_name']."</B></center></P>";
