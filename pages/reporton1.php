...
if (($_COOKIE['tsr_emp_permit'] == 4 )) {
  if (substr($_COOKIE['tsr_emp_id'],0,1) == "0") {
    ...
    $WHERE .= "AND R.ZoneCode IN (
      SELECT DISTINCT Salecode  FROM [TSRData_Source].[dbo].[EmployeeDataParent_ALL] WHERE StatusType = 'on' AND (EmployeeCodeLV2 = '".$EmpID['0']."' OR EmployeeCodeLV3 = '".$EmpID['0']."'   OR EmployeeCodeLV4 = '".$EmpID['0']."' OR EmployeeCodeLV5 = '".$EmpID['0']."' OR EmployeeCodeLV6 = '".$EmpID['0']."' OR ParentEmployeeCode = '".$EmpID['0']."')  )
 ";
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reporton1">
        <div class="col-md-2">
          <h4>
            เก็บเงินงวดแรก
          </h4>
