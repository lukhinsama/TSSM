          ...
          <!--<div class="box-body">-->
            ...
            <tbody>";
              ...
              while ($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)) {
                if ($row['PaymentComplete'] == '1' AND ($row['NetAmount'] == $row['TotalPayment'])) {
                  $complete = 'ส่งครบ';
              ...
              <tr>
                ...
                if ($row['TotalPayment'] == '0') {
                  ...
                  <td style="text-align: right"><a class="text-danger"><?=number_format($row['TotalPayment'],2)?></a></td>
                  ...
                  <?PHP
                }elseif ($row['NetAmount'] != $row['TotalPayment']) {
                    ?>
                    ...
                    <td style="text-align: right"><a class="text-warning"><?=number_format($row['TotalPayment'],2)?></a></td>
