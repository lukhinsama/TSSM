  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> เพิ่มรายการเก็บเงิน</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="http://app.thiensurat.co.th/tsr_ASP_tsr_SaleAdvance/frm_AddAmtByEmployee.aspx?sid=<?=$_GET['sid']?>"></iframe>
          </div>
        </div>
