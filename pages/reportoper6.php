  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-md-3">
          <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportoper6">
        ...
        <div class="col-md-12">
          <?php
           ...
           <?php
            ...
            ,Trip.SERVICE as Zone
            ,ed.SupervisorCode
            ,(SELECT COUNT(RefNo) AS RefNo FROM
            (SELECT DISTINCT RefNo FROM [Bighead_Mobile].[dbo].[Payment] WHERE CashCode = Trip.SERVICE AND TripID = '".$tip[0]."' AND PAYAMT > 0) AS A) AS sumCont
            ...
            INNER JOIN Bighead_Mobile.dbo.Receipt AS R ON R.ReceiptID = sp.ReceiptID
            WHERE CashCode = Trip.SERVICE AND TripID = '".$tip[0]."' AND TotalPayment > 0) AS sumReceipt
            ,$dateTo1
            ,$dateTo2
            ...
            WHERE  ed.SourceSystem != 'sale' $WHERE
