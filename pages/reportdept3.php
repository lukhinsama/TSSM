  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-md-3">
          <form role="form" data-toggle="validator" id="formSearch" name="formSearch" method="post" action="index.php?pages=reportdept3">
            <?php
              if (($_COOKIE['tsr_emp_permit'] != 4 )) {
             ?>
          ...
          <?php
           ...
           <div class="box-body table-responsive no-padding">
             ...
             <table class="table table-hover table-striped">
               ...
               WHERE SourceSystem != 'Sale' AND PositionCode like 'dept%'
               $WHERE
