...
,S.PaymentPeriodNumber ,S.PaymentComplete ,S.PaymentDueDate ,S.PaymentAppointmentDate
--,S.NetAmount
,S.NetAmount - SUM(SP.Amount) AS NetAmount
,S.TripID
,SP.CreateDate
...
GROUP BY S.SalePaymentPeriodID ,S.RefNo ,C.CONTNO ,D.CustomerName
,S.PaymentPeriodNumber ,S.PaymentComplete ,S.PaymentDueDate ,S.PaymentAppointmentDate
,S.NetAmount
,S.TripID
,SP.CreateDate";
